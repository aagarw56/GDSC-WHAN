        ...
        <section className="topic-hero">
          <div className="topic-container">
            ...
            <div className="topic-note">
              ...
              If you can’t safely speak, consider texting 911 (availability varies by area).
            </div>
          </div>
        </section>
        ...
        <div className="topic-container topic-body">
          ...
          <section className="topic-section">
            ...
            <p className="section-lead">
              ...
              sharing these numbers is not to scare you, it’s to validate concerns, encourage
          ...
          <section className="topic-section" id="hotlines">
            ...
            <p className="section-lead">
              If you’re not sure what to do next, these services can help you talk through options
            ...
            <div className="resource-grid">
              ...
              <div className="resource-card">
                ...
                <p>
                  If you’re overwhelmed, scared, or in crisis, help is available.
                </p>
                <a
          ...
          <section className="topic-section">
            ...
            <ul className="checklist">
              <li>Turn off “precise location” for apps that don’t need it.</li>
          ...
          <section className="topic-section closing">
            ...
            <p>
              You don’t have to handle this by yourself. Whether you want to report,
